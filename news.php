...
<h1 style="text-align:center;color:white;text-shadow:2px 2px 2px white;">News Management</h1>
...
if($conn==true)	
{
 ...
 if(mysqli_num_rows($x))
 {
	...
	{
		$a++;
	echo "<tr><td>$a</td><td>".$row["title"]."</td><td><img src=../addnews/".$row["profile"]."
	height='50px' width='50px'/></td><td>".$row["description"]."<td>".$row["ddt"]."</td>
	<td><a href='../codes/delnews.php/?v=".$row["title"]."'><span class='fa fa-trash'></span></a></td></tr>";	
	}
 }
 else
 {
