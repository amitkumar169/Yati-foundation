...
<h1 style="text-align:center;color:white;text-shadow:2px 2px 2px white;">Add News</h1>

<div class="row">
<div class="col-sm-3"></div>

                        <div class="col-sm-6"
                        style="border:2px solid #000;border-radius:10px; margin-top:20px; color:#000; margin-bottom:30px;">
                        <form action="../codes/adcode.php" method="post" enctype="multipart/form-data">
                            
                            <span style="color:#fff;"><b>Select File</b></span>
                            <input class="form-control" type="text" name="title" placeholder="New Title"
                                style="height:40px;width:100%;border:1px solid black;margin-top:10px;" />
                            <input type="file" name="file" class="form-control" placeholder="Select File"
                                style="margin-top:30px;color:white;" /><br /><br />
                            <span style="color:#000;">Description</span>
                            <input type="text" name="newsdec" placeholder="Description" class="form-control"
                                style="height:150px;width:100%;border:1px solid black;margin-top:10px;" />
                            <!-- <input type="submit" name="upload" placeholder="upload"
							style="margin-top:30px;border:1px solid black;" /> -->
