...
<div class="row">
<div class="col-sm-6">
<img src="f.jpg" style="height:620px;width:100%;margin-top:5px;border-radius:20px;"/>

</div>
<div class="col-sm-6" style="height:650px;width:100%;border:0px solid black;margin-bottom:0px;">
<form class="contact-form" style="margin-top:5px;" method="post" action="codes/vcode.php" enctype="multipart/form-data">
